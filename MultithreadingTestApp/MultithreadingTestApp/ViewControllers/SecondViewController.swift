...
final class SecondViewController: UIViewController {
    ...
    @IBOutlet private weak var downloadTypeLabel: UILabel!
    ...
    var urlsForDownloadImage = [
        ...
        "http://img.bezkassira.by/img/organise/1996/large/8876_05d7d-1585226695.png",
        ...
        "http://img.bezkassira.by/img/organise/2009/large/8360_6917a-1584455486.jpg",
        ...
        "http://img.bezkassira.by/img/organise/1996/large/8688_97f7e-1582742084.png",
    ...
    override func viewDidLoad() {
        ...
        downloadTypeLabel.text = downloadType
    ...
    //MARK: - Supporting
    private func showAllert(errorCounter: Int, successCounter: Int) {
    ...
    private func dowloadImagesOneByOne() {
        var index = 0
    ...
    private func dowloadImagesAsync() {
        var successCounter = 0
        var errorCounter = 0
        activityIndicatorView.startAnimating()
        let dispatchGroup = DispatchGroup()
